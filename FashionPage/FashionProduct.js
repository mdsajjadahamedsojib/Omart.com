        ...
        fashionSection.innerHTML = products.map(product => {
            ...
            return `
                <div class="fashion-product-container">
                    ...
                    <div class="add-to-cart flex">
                        <!-- Shop Now বাটনে ক্লিক করলে ডিটেইলস পেজে নিয়ে যাবে -->
                        <button class="btn" onclick="goToProductDetails(${product.id})">
                            <h4>shop now</h4>
                        </button>
                    </div>
                </div>
...
// FashionPage থেকে ProductDetailsPage-এ যাওয়ার সঠিক রিলেটিভ পাথ
